...
namespace celostad\QueueMonitor\Services;
...
class QueueMonitor
{
    ...
    /**
     * @var \celostad\QueueMonitor\Models\Contracts\MonitorContract
     */
    public static $model;
     ...
     *
     * @return \celostad\QueueMonitor\Models\Contracts\MonitorContract
     */
